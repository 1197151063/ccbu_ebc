...
public class DepartmentController {
    ...
    @ApiOperation(value = "查询项目表",notes = "@author SMS")
    @PostMapping("/department/sysProject/query")
    public ResponseDTO<List<SysProjectVO>> queryBy(@RequestBody SysProjectQueryDTO queryDTO) {
        return sysProjectService.queryBy(queryDTO);
    }
