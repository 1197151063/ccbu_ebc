...
public interface DepartmentDao extends BaseMapper<DepartmentEntity> {
    ...
    String queryName(@Param("departmentId")Long departmentId);

    List<Long> queryProject(@Param("currentProjectId")Long currentProjectId);

    List<DepartmentVO> queryDeptListByProId(@Param("currentProjectId")Long currentProjectId);
}
