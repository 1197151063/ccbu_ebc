...
public class CommonConst {
    ...
    public static final class CommonCollection {
        public static final Set<String> IGNORE_URL = ImmutableSet.of("/swagger", "Excel","/service");
        public static final Set<String> IGNORE_URL_WEB = ImmutableSet.of("/swagger", "Excel");
